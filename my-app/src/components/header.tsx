    ...
    <div className="header clearfix">
      <aside className="header__aside">
        <svg width="90" height="20" viewBox="0 0 90 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M33.2735 17L32.5778 14.948H28.154L27.4584 17H23.7838L28.6892 4.4H32.0427L37.0551 17H33.2735ZM31.7394 12.23L30.3659 8.324L28.9924 12.23H31.7394Z" fill="#31B768"/>
